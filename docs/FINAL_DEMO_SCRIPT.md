...
Status: **live presentation flow**.

1. Open `/demo?recording=1` and confirm the home composer is visible.
2. Press `1`. Let the request type itself, the eight-source funnel narrow and the PLN 277.73 decision settle.
3. Press `Escape` to return home.
4. Press `2`. Let the OLX evidence, fictional negotiation and protected PLN 930 checkout settle.
