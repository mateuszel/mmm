...
| S2-OLX-SEARCH | 2 | [current OLX search](https://www.olx.pl/elektronika/gry-konsole/q-nintendo-switch-oled/) | `sources/olx/olx-switch-search-fullpage.webp` | top, results, browser, thumb | Current real results, titles, images and protected-price badges | No seller name/avatar/phone; only city labels retained | Real OLX search context; not the fictional conversation | Accepted |
