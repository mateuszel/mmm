...
const retail: ScenarioDefinition = {
  ...
  stages: [
    ...
    { id: "market-search", startMs: 5_500, durationMs: 2_500, visibleCopy: ["Searching trusted stores", "8 sources checked", "4 viable offers", "2 best matching offers"], activeComponents: ["source-funnel", "progress-line"], assetReferences: [], layoutState: "search", animationType: "stagger", audioEvent: "none", nextStage: "finalists", finalState: false },
    { id: "finalists", startMs: 8_000, durationMs: 3_000, visibleCopy: ["2 best matching offers"], activeComponents: ["adidas-capture", "eobuwie-capture"], assetReferences: ["/demo-assets/sources/adidas/adidas-ig1024-viewport.webp", "/demo-assets/sources/retail/eobuwie-ig1024-viewport.webp"], layoutState: "comparison", animationType: "expand", audioEvent: "none", nextStage: "coupon", finalState: false },
    { id: "coupon", startMs: 11_000, durationMs: 3_500, visibleCopy: ["Validating SUMMER30", "Ceneo price history checked", "Coupon valid", "eobuwie promotion unavailable"], activeComponents: ["coupon-validation", "decision-trail", "price-history"], assetReferences: [], layoutState: "comparison", animationType: "calculate", audioEvent: "none", nextStage: "true-cost", finalState: false },
    { id: "true-cost", startMs: 14_500, durationMs: 2_000, visibleCopy: ["396.75 PLN", "-119.02 PLN", "277.73 PLN"], activeComponents: ["cost-calculation", "offer-status"], assetReferences: [], layoutState: "decision", animationType: "calculate", audioEvent: "none", nextStage: "decision", finalState: false },
    { id: "decision", startMs: 16_500, durationMs: 1_500, visibleCopy: ["adidas selected", "Use valid coupons only. Show total landed cost."], activeComponents: ["selected-offer", "protected-handoff"], assetReferences: [], layoutState: "decision", animationType: "decision", audioEvent: "none", nextStage: "final", finalState: false },
    { id: "final", startMs: 18_000, durationMs: null, visibleCopy: ["277.73 PLN", "Protected handoff complete"], activeComponents: ["retail-final"], assetReferences: [], layoutState: "decision", animationType: "decision", audioEvent: "none", nextStage: null, finalState: true },
  ],
};
