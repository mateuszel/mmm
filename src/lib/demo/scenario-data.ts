...
const privateSeller: ScenarioDefinition = {
  ...
  stages: [
    ...
    { id: "evidence", startMs: 11_000, durationMs: 3_000, visibleCopy: ["Of course — I’m sending the photos now."], activeComponents: ["seller-reply", "evidence-images", "ledger"], assetReferences: ["/demo-assets/product/switch-touchscreen-simulated.webp", "/demo-assets/product/switch-bundle-simulated.png"], layoutState: "conversation", animationType: "stagger", audioEvent: "none", nextStage: "negotiate", finalState: false },
...
export const callLines = [
  { startMs: 0, endMs: 10_843.810, speaker: "Relyo", text: "Hallo! Ich melde mich wegen der Fujifilm X100V. Können Sie mir kurz sagen, in welchem technischen Zustand sie ist, und vielleicht noch ein paar Fotos schicken?", risk: null, audio: "/demo-assets/audio/german-call/1.wav" },
  { startMs: 11_193.810, endMs: 23_152.290, speaker: "Seller", text: "Ähm ja, hören Sie, lassen Sie uns das doch privat regeln. Ich hab keine Lust auf die ganzen versteckten Gebühren bei eBay. Überweisen Sie mir das Geld einfach direkt, dann schicke ich Ihnen die Kamera. Ohne zusätzlichen Mist.", risk: "Off-platform payment and direct transfer requested", audio: "/demo-assets/audio/german-call/2.wav" },
  { startMs: 23_502.290, endMs: 28_375.306, speaker: "Relyo", text: "Ähm, sorry, aber sicherheitshalber würde ich das lieber über eBay abwickeln.", risk: null, audio: "/demo-assets/audio/german-call/3.wav" },
  { startMs: 28_725.306, endMs: 36_468.912, speaker: "Seller", text: "Ich meine, das ist doch eine Win-win-Situation für uns beide. Ich schicke Ihnen die Zahlungsdaten, schicken Sie mir einfach die Lieferadresse über WhatsApp.", risk: "Payment details and personal data requested outside eBay", audio: "/demo-assets/audio/german-call/4.wav" },
  { startMs: 36_818.912, endMs: 41_772.268, speaker: "Relyo", text: "Ähm, ich fühle mich einfach nicht wohl dabei, das außerhalb von eBay zu machen. Tut mir leid.", risk: null, audio: "/demo-assets/audio/german-call/5.wav" },
  { startMs: 42_122.268, endMs: 46_925.238, speaker: "Seller", text: "Ach, fahren Sie zur Hölle. Wenn Sie es nicht ernst meinen, verschwenden Sie nicht meine Zeit.", risk: "Seller ended the call", audio: "/demo-assets/audio/german-call/6.wav" },
] as const;
...
const foreign: ScenarioDefinition = {
  ...
  assets: [
    ...
    "/demo-assets/audio/german-call/combined.wav",
  ],
  stages: [
    ...
    { id: "call-01", startMs: 4_000, durationMs: 11_193.810, visibleCopy: [callLines[0].text], activeComponents: ["call", "timer", "waveform", "transcript"], assetReferences: ["/demo-assets/audio/german-call/combined.wav"], layoutState: "call", animationType: "compose", audioEvent: "call-start", nextStage: "call-02", finalState: false },
    { id: "call-02", startMs: 15_193.810, durationMs: 12_308.480, visibleCopy: [callLines[1].text, callLines[1].risk!], activeComponents: ["call", "transcript", "risk-critical"], assetReferences: [], layoutState: "call", animationType: "risk", audioEvent: "none", nextStage: "call-03", finalState: false },
    { id: "call-03", startMs: 27_502.290, durationMs: 5_223.016, visibleCopy: [callLines[2].text], activeComponents: ["call", "transcript"], assetReferences: [], layoutState: "call", animationType: "compose", audioEvent: "none", nextStage: "call-04", finalState: false },
    { id: "call-04", startMs: 32_725.306, durationMs: 8_093.606, visibleCopy: [callLines[3].text, callLines[3].risk!], activeComponents: ["call", "transcript", "risk-personal-data"], assetReferences: [], layoutState: "call", animationType: "risk", audioEvent: "none", nextStage: "call-05", finalState: false },
    { id: "call-05", startMs: 40_818.912, durationMs: 5_303.356, visibleCopy: [callLines[4].text], activeComponents: ["call", "transcript"], assetReferences: [], layoutState: "call", animationType: "compose", audioEvent: "none", nextStage: "call-06", finalState: false },
    { id: "call-06", startMs: 46_122.268, durationMs: 4_802.970, visibleCopy: [callLines[5].text, callLines[5].risk!], activeComponents: ["call", "transcript", "call-ended", "analysis"], assetReferences: [], layoutState: "decision", animationType: "risk", audioEvent: "call-stop", nextStage: "final", finalState: false },
    { id: "final", startMs: 50_925.238, durationMs: null, visibleCopy: ["Listing rejected", "No money was transferred", "No personal data was shared", "Search continuing"], activeComponents: ["foreign-final", "risk-ledger"], assetReferences: [], layoutState: "decision", animationType: "decision", audioEvent: "call-stop", nextStage: null, finalState: true },
  ],
};
